...
const loadGoogleMapsScript = () => {
  return new Promise((resolve, reject, ) => {
    ...
    script.src = `https://maps.googleapis.com/maps/api/js?key=${GOOGLE_MAPS_API_KEY}&v=weekly&loading=async&libraries=places,drawing,marker&callback=initGoogleMaps`;
    script.async = true;
    script.defer = true;
